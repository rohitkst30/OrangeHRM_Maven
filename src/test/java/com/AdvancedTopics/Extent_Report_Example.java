...
public class Extent_Report_Example {
	...
	ExtentReports extent;// helps to generate the logs in test report.
	ExtentTest test;
...
//		driver = new FirefoxDriver();
	...
	public void startReport() {
		htmlReporter =
			new ExtentSparkReporter(System.getProperty("user.dir") + "/test-output/testReport.html");// initialize the HtmlReporter
		extent = new ExtentReports();// initialize ExtentReports and attach the HtmlReporter
		extent.attachReporter(htmlReporter);
		
		extent.setSystemInfo("OS", System.getProperty("os.name"));//To add system or environment info by using the setSystemInfo method.
